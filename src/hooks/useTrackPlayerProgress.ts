...
import { type ProgressState } from "../interfaces/ProgressState";
import { useTrackPlayerPlaybackState } from "./useTrackPlayerPlaybackState";
import { getBufferedPosition, getDuration, getPosition } from "../trackPlayer";

export function useTrackPlayerProgress(updateIntervalMs?: number): ProgressState {
