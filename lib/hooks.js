...
exports.usePlaybackState = function () {
    ...
    react_1.useEffect(function () {
        ...
        function setPlayerState() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, player_1.default.getState()];
                        case 1:
                            playerState = _a.sent();
                            if (isSubscribed) {
        ...
        setPlayerState();
        var sub = player_1.default.addEventListener(interfaces_1.Event.PlaybackState, function (data) {
            if (isSubscribed) {
                setState(data.state);
            }
        });
...
exports.useTrackPlayerEvents = function (events, handler) {
    ...
    react_1.useEffect(function () {
        ...
        var subs = events.map(function (event) {
            ...
            return player_1.default.addEventListener(event, function (payload) {
                if (isSubscribed && (savedHandler === null || savedHandler === void 0 ? void 0 : savedHandler.current)) {
...
function useProgress(updateInterval) {
    ...
    react_1.useEffect(function () {
        var isSubscribed = true;
        if (playerState === interfaces_1.State.Stopped) {
            setState({ position: 0, duration: 0, buffered: 0 });
            return;
        }
        if (playerState !== interfaces_1.State.Playing && playerState !== interfaces_1.State.Buffering)
            return;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.all([
                            player_1.default.getPosition(),
                            player_1.default.getDuration(),
                            player_1.default.getBufferedPosition(),
                        ])];
                    case 1:
