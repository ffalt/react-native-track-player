...
var useTrackPlayerHasNext = function () {
    ...
    (0, exports.useTrackPlayerEvents)([interfaces_1.Event.PlaybackTrackChanged, interfaces_1.Event.ShuffleModeChanged], function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
