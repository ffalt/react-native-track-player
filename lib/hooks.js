...
function useTrackPlayerCurrentTrackNr() {
    var _this = this;
    return useTrackPlayerDataEvent(interfaces_1.Event.PlaybackTrackChanged, function (payload) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, payload ? noNull(payload === null || payload === void 0 ? void 0 : payload.nextTrack) : trackPlayer_1.default.getCurrentTrack()];
...
var useTrackPlayerProgressMS = function (interval) {
    if (interval === void 0) { interval = 1000; }
    var _a = (0, react_1.useState)({
        duration: 0,
        position: 0
...
var useTrackPlayerHasNext = function () {
    return useTrackPlayerDataEvents([interfaces_1.Event.PlaybackTrackChanged, interfaces_1.Event.ShuffleModeChanged, interfaces_1.Event.QueueChanged], function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
...
var useTrackPlayerHasSiblings = function () {
    return useTrackPlayerDataEvents([interfaces_1.Event.PlaybackTrackChanged, interfaces_1.Event.ShuffleModeChanged, interfaces_1.Event.QueueChanged], function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
