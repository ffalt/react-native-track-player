...
function useTrackPlayerDownload(url) {
    var _this = this;
    ...
    (0, react_1.useEffect)(function () {
        ...
        var fetchDownloads = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, trackPlayer_1.default.getDownload(url)];
                    case 1:
                        fetched = _a.sent();
                        if (!didCancel) {
                            setDownload(fetched);
    ...
    (0, exports.useTrackPlayerEvent)(interfaces_1.Event.DownloadChanged, function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = setDownload;
                    return [4 /*yield*/, trackPlayer_1.default.getDownload(url)];
                case 1:
                    _a.apply(void 0, [_b.sent()]);
                    return [2 /*return*/];
            }
