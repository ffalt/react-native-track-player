...
exports.useTrackPlayerDownloadCached = exports.useTrackPlayerCurrentDownloadsCached = exports.TrackPlayerDownloadManager = void 0;
...
var TrackPlayerDownloadManager = /** @class */ (function () {
    ...
    TrackPlayerDownloadManager.prototype.getDownload = function (id) {
        return this.downloads.find(function (d) { return d.id === id; });
    };
    ...
    TrackPlayerDownloadManager.prototype.getCurrentDownloads = function () {
        return this.downloads.filter(function (d) { return d.state !== interfaces_1.DownloadState.Completed; });
    };
    TrackPlayerDownloadManager.prototype.updateDownload = function (id, state) {
        return __awaiter(this, void 0, void 0, function () {
            var downloadIndex, download;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(state === interfaces_1.DownloadState.Removing)) return [3 /*break*/, 1];
                        this.downloads = this.downloads.filter(function (d) { return d.id === id; });
                        this.notifyDownloadsChange();
                        return [3 /*break*/, 3];
                    case 1:
                        downloadIndex = this.downloads.findIndex(function (d) { return d.id === id; });
    ...
    TrackPlayerDownloadManager.prototype.updateDownloadProgress = function (id, contentLength, bytesDownloaded, percentDownloaded) {
        return __awaiter(this, void 0, void 0, function () {
            var download;
            return __generator(this, function (_a) {
                download = this.downloads.find(function (d) { return d.id === id; });
                if (download) {
    ...
    TrackPlayerDownloadManager.prototype.notifyDownloadsChange = function () {
        var _this = this;
        this.downloadsChangeSubscriptions.forEach(function (update) { return update(_this.downloads); });
    };
...
function useTrackPlayerCurrentDownloadsCached(cache) {
    ...
    var refresh = (0, react_1.useCallback)(function (downloads) {
...
function useTrackPlayerDownloadCached(id, cache) {
    ...
    var refresh = (0, react_1.useCallback)(function (download) {
